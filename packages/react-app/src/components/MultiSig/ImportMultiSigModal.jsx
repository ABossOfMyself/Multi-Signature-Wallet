...
export default function ImportMultiSigModal({
  ...
  const handleSubmit = async () => {
    try {
      ...
      await contract.getSignaturesRequired();
  ...
  return (
    <>
      ...
      <Modal
        title="Import - Multi Signature Wallet"
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          <AddressInput
            ...
            placeholder={"Multi Signature Wallet address"}
            value={address}
            onChange={setAddress}
          />
          ...
          {error && <Alert message="Unable to import: This doesn't seem like a Multi Signature Wallet." type="error" showIcon />}
        </div>
      </Modal>
    </>
  );
