  ...
  return (
    <div>
      ...
      <div style={{ marginTop: 32 }}>
        ...
        <span
          className="highlight"
          style={{ marginLeft: 4, marginRight: 4, /* backgroundColor: "#f9f9f9", */ padding: 4, borderRadius: 4, fontWeight: "bolder" }}
        >
      ...
      <div style={{ marginTop: 32 }}>
        ...
        <span
          className="highlight"
          style={{ marginRight: 4, /* backgroundColor: "#f1f1f1", */ padding: 4, borderRadius: 4, fontWeight: "bolder" }}
        >
          yarn run generate
        </span>
      ...
      <div style={{ marginTop: 32 }}>
        ...
        <span
          ...
          style={{ marginLeft: 4, /* backgroundColor: "#f9f9f9", */ padding: 4, borderRadius: 4, fontWeight: "bolder" }}
        >
          <a target="_blank" rel="noopener noreferrer" href="https://github.com/ABossOfMyself/Multi-Signature-Wallet.git">
            Github Repository
          </a>
        </span>
      </div>
