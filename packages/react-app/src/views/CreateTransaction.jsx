  ...
  const createTransaction = async () => {
    try {
      ...
      if (newSignaturesRequired < 1) {
        ...
        const isOwner = await readContracts[contractName].isOwnerAddress(recover);
          ...
          <div style={{ margin: 8, padding: 8 }}>
            <Select value={methodName} style={{ width: "100%" }} onChange={setMethodName}>
              ...
              <Option key="wcCallData">
                <img src="https://gitcoin.co/dynamic/avatar/walletconnect" style={{ height: 20, width: 20 }} /> WalletConnect
              </Option>
            </Select>
          </div>
            ...
            <>
              <div style={inputStyle}>
                <AddressInput
                  ...
                  placeholder={methodName == "transferFunds" ? "Recipient address" : "Owner address"}
                  value={to}
                  onChange={setTo}
                />
              </div>
              <div style={inputStyle}>
                {(methodName == "addOwner" || methodName == "removeOwner") && (
                  <InputNumber
                    style={{ width: "100%" }}
                    placeholder="New number of signatures required"
